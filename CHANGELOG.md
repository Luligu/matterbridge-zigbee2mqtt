...
- [action]: Added support for devices with more then 3 events. All SwitchCluster actions are mapped in groups of 3 on sub endpoints. The mapping schema is shown in log. 
