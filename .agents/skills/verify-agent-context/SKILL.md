...
description: Verify which coding agent is running and that it loaded the shared repository instructions, rules and skills from AGENTS.md and .agents/. Use when the user asks to check, test or debug the agent configuration. v.1.0.0
---
