...
```
AGENTS.md                              the shared instructions themselves — style, scope, testing, Matterbridge
...
| `rules/chip-tests.instructions.md`      | The CHIP conformance test harness                     |
...
description: Verify which coding agent is running and that it loaded ... v.1.0.0
---
```
...
`.claude/skills/*` and `.github/skills/*` wrappers work the same way for skills.
