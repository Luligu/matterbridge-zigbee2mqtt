...
export const WindowCoveringDefaultClusterHandler: () => ClusterServerHandlers<typeof WindowCovering.Complete> = () => ({
  upOrOpen: async ({ request: request, attributes: attributes }) => {
    throw new NotImplementedError('Not implemented');
  },
  downOrClose: async ({ request: request, attributes: attributes }) => {
    throw new NotImplementedError('Not implemented');
  },
  stopMotion: async ({ request: request, attributes: attributes }) => {
    throw new NotImplementedError('Not implemented');
  },
  goToLiftPercentage: async ({ request: { liftPercent100thsValue }, attributes: { currentPositionLiftPercent100ths, targetPositionLiftPercent100ths } }) => {
